  ...
  <div class="font-merriweather">
    ...
    <div>
      <div class="bg-yellow h-[50rem]">
        <div class="w-[60%] pt-[10rem] float-left">
          <h2 class="w-[60%] ml-[10%] text-6xl text-brown">
      ...
      <div class="bg-light-yellow h-[50rem]">
        <div class="w-[60%] pt-[10rem] float-right">
          <h2
            class="w-[60%] mr-[8%] float-right text-6xl text-brown text-right"
          >
    ...
    <div class="bg-light-gray h-[50rem]">
      <div class="w-[40%] pt-[10rem] float-left">
        <h2 class="w-[55%] ml-[10%] text-6xl text-brown">
      ...
      <div
        class="w-[45%] h-[70%] mt-[5%] mr-20 float-right bg-gradient-to-br from-yellow to-light-yellow"
      ></div>
    </div>
  </div>
</template>
